...
print("==========================================================================")
print("  RUNNING MT5 MONTHLY BACKTEST FOR EA V12 (DEPOSIT: 650 USC | 2024-2026) ")
print("==========================================================================")
...
out_json = r"D:\Trade_Gus\Results_Data\v12_650usc_monthly_backtest_results.json"
...
print("\n" + "="*100)
print(f"  SUMMARY OF V12 MONTHLY BACKTEST RESULTS (DEPOSIT: 650 USC | 2024-08 TO 2026-08)  ")
print("="*100)
for r in results:
...
print("="*100)
print(f"TOTAL NET PROFIT OVER 25 MONTHS: ${total_net_profit:+.2f} USC ({(total_net_profit/650.0)*100:+.2f}%)")
print(f"FINAL BALANCE: ${650.0 + total_net_profit:.2f} USC")
print("="*100)
