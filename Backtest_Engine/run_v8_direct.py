...
ini_path = r"D:\Trade_Gus\Backtest_Engine\v8_fibo_run.ini"
report_path = r"D:\Trade_Gus\Reports_and_Docs\EA_v8_Fibo_Report.html"

# Kill existing terminal process
subprocess.run("taskkill /F /IM terminal64.exe", shell=True, capture_output=True)
time.sleep(1)

print("Executing MT5 Native Strategy Tester for EA v8.0 SMC Custom Fibo...")
...
if found:
    ...
    print("\n=================== MT5 EA v8.0 SMC CUSTOM FIBO REPORT ===================")
    for row in rows:
    ...
    print("Test in progress or executed in MT5.")
