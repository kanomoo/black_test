...
ea_source = r"D:\Trade_Gus\EA_Source\XAUUSD_Apex_Champion_v14.ex5"
ea_name = "XAUUSD_Apex_Champion_v14.ex5"
...
print("==========================================================================")
print("  RUNNING MT5 MONTHLY BACKTEST FOR EA V14 (DEPOSIT: 650 USC | 2024-2026) ")
print("==========================================================================")
...
out_json = r"D:\Trade_Gus\Results_Data\v14_650usc_monthly_backtest_results.json"
...
print("\n" + "="*100)
print(f"  SUMMARY OF V14 MONTHLY BACKTEST RESULTS (DEPOSIT: 650 USC | 2024-08 TO 2026-08)  ")
print("="*100)
for r in results:
