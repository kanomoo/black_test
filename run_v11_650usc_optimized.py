...
print("==========================================================================")
print("  RUNNING MT5 MONTHLY BACKTEST FOR EA V11 OPTIMIZED (DEPOSIT: 650 USC) ")
print("==========================================================================")
...
out_json = r"D:\Trade_Gus\Results_Data\v11_opt_650usc_monthly_backtest_results.json"
...
print("\n" + "="*100)
print(f"  SUMMARY OF V11 OPTIMIZED MONTHLY BACKTEST RESULTS (DEPOSIT: 650 USC | 2024-08 TO 2026-08)  ")
print("="*100)
for r in results:
