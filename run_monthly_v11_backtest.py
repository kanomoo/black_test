...
ea_source = r"D:\Trade_Gus\EA_Source\XAUUSD_Apex_Champion_v11.ex5"
...
print("==========================================================================")
print("  RUNNING MT5 MONTHLY BACKTEST FOR XAUUSD_Apex_Champion_v11.ex5 (2024-2026) ")
print("==========================================================================")
...
out_json = r"D:\Trade_Gus\Results_Data\v11_monthly_backtest_results.json"
os.makedirs(os.path.dirname(out_json), exist_ok=True)
with open(out_json, "w", encoding="utf-8") as f:
    json.dump(results, f, indent=2)

print("\n" + "="*100)
print("  SUMMARY OF V11 MONTHLY BACKTEST RESULTS (2024-08 TO 2026-08)  ")
print("="*100)
for r in results:
