...
print("==========================================================================")
print("  LAUNCHING LIVE VISUAL MT5 STRATEGY TESTER ON FOREGROUND DESKTOP       ")
print("==========================================================================")
...
# 2. Write INI file with Visual=1 (Forces Live Visual Chart Backtest Mode)
ini_path = r"D:\Trade_Gus\visual_foreground_tester.ini"
ini_content = """[Tester]
...
# 3. Attach thread to WinSta0\Default
hdesk = user32.OpenDesktopW("Default", 0, False, GENERIC_ALL)
if hdesk:
    user32.SetThreadDesktop(hdesk)

# 4. Spawn MT5 with Visual=1 directly onto physical desktop
si = STARTUPINFO()
...
# 5. Bring Visual Tester window to top foreground
target_hwnds = []
def cb(hwnd, extra):
