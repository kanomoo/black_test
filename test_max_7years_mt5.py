...
print("==========================================================================")
print("  RUNNING MAXIMUM POSSIBLE HISTORICAL BACKTEST (2019.07.24 - 2026.08.24 - 7 YEARS)  ")
print("==========================================================================")

report_filename = "Report_MT5_Max7Years_2019_2026.html"
report_full_path = os.path.join(report_dir, report_filename)
if os.path.exists(report_full_path):
    try: os.remove(report_full_path)
    except: pass

ini_path = os.path.join(mt5_dir, "test_max_7years.ini")
...
if parsed:
    print("\n" + "="*80)
    print("  MAXIMUM 7-YEAR MT5 OFFICIAL STRATEGY TESTER REPORT SUMMARY  ")
    print("="*80)
    ...
    out_json = r"D:\Trade_Gus\Results_Data\max_7years_mt5_report.json"
    os.makedirs(os.path.dirname(out_json), exist_ok=True)
    with open(out_json, "w", encoding="utf-8") as f:
        json.dump(parsed, f, indent=2)
else:
    print("WARNING: Could not parse 7-year report.")
